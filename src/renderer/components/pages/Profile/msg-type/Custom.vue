  ...
  <div class="msg_text"
    ...
    <div class="msg_text_box"
      ...
      <div class="msg_text_box_left">
        <div class="msg_text_box_left_title">{{info.content.msg_body.name || ''}}</div>
        <div class="msg_text_box_left_desc">{{info.content.msg_body.desc || ''}}</div>
        <div class="msg_text_box_left_auth">{{info.content.from_name || ''}}</div>
      </div>
...
export default {
  ...
  methods: {
    clickHandler () {
      ...
      ipcRenderer.send('open-window', this.info)
    }
  }
}
</script>
